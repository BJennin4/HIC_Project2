            ...
            <Card className='card-container'>
                <Card.Body>
                    <Card.Title className='card-title'>The Event On October Seventh</Card.Title>
                        <img src="./whitebackground.png"     className="background" />
                        <img src="./isrealattackoverlay.png" className="oct1Pic" />
